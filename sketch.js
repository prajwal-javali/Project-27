...
var roof, bob1, bob2, bob3, bob4, bob5, rope1, rope2, rope3, rope4, rope5, bobDiameter;
...
function setup() {
	...
	bob3 = new Bob(350, 300, 50, 50);
	bob4 = new Bob(450, 300,  50, 50);
	bob5 = new Bob(500, 300, 50, 50);
...
function keyPressed() {
	if (keyCode === UP_ARROW) {
		Matter.Body.applyForce(bob2.body, bob2.body.position, {x: -20, y: 30})
	}
}
